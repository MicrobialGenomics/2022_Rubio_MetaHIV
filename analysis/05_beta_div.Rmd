...
```{r}
ariba_dist$meta_rar%>%count(RiskGroup2)
...
```{r}
pairwise_riskgroup2(ariba_dist$dist_rpkm, ariba_dist$meta_rpkm)
pairwise_riskgroup2(ariba_dist$dist_rar, ariba_dist$meta_rar)
```
...
```{r}
pairwise_riskgroup2(groot_dist$dist_rpkm, groot_dist$meta_rpkm)
pairwise_riskgroup2(groot_dist$dist_rar, groot_dist$meta_rar)
```
