...
```{r}
alpha_div_plot_all(ariba_alpha_rpkm, MSM_dic)+labs(subtitle = "Ariba RPKM")
alpha_div_plot_all(ariba_alpha_rar, MSM_dic)+labs(subtitle = "Ariba Rarefied counts")
```
...
```{r}
alpha_div_plot_all(ariba_alpha_rpkm, GCount)+labs(subtitle = "Ariba RPKM")
alpha_div_plot_all(ariba_alpha_rar, GCount)+labs(subtitle = "Ariba Rarefied counts")
```
...
alpha_div_cor_all(slice(ariba_alpha_rpkm, -high_ratio), ratio_CD4_CD8)+labs(subtitle = "Ariba RPKM")
alpha_div_cor_all(slice(ariba_alpha_rar, -high_ratio), ratio_CD4_CD8)+labs(subtitle = "Ariba Rarefied counts")
```
...
```{r}
alpha_div_cor_all(slice(ariba_alpha_rpkm, -high_ratio), CD8_absolute)+labs(subtitle = "Ariba RPKM")
alpha_div_cor_all(slice(ariba_alpha_rpkm, -high_ratio), CD8_absolute)+labs(subtitle = "Ariba Rarefied counts")
```
...
```{r}
alpha_div_plot_all(groot_alpha_rpkm, MSM_dic)+labs(subtitle = "Groot RPKM")
alpha_div_plot_all(groot_alpha_rar, MSM_dic)+labs(subtitle = "Groot Rarefied counts")
```
...
```{r}
alpha_div_plot_all(groot_alpha_rpkm, GCount)+labs(subtitle = "Groot RPKM")
alpha_div_plot_all(groot_alpha_rar, GCount)+labs(subtitle = "Groot Rarefied counts")
```
...
```{r}
alpha_div_cor_all(slice(groot_alpha_rpkm, -high_ratio), CD8_absolute)+labs(subtitle = "Groot RPKM")
alpha_div_cor_all(slice(groot_alpha_rpkm, -high_ratio), CD8_absolute)+labs(subtitle = "Groot Rarefied counts")
```
...
-   **Gene richness:** Lower alpha diversity (Simpson/InvSimpson
    and Shannon) in LGC. 
    
-   **CD4, Nadir CD4, CD8, CD4/CD8 ratio:** No significant correlation between CD4 levels
