...
refname_all_groot%>%slice(n=569)


head(refname_all_groot, 15)%>%kable(caption="**Groot detected ARG with CARD information** ")%>%kable_paper("striped")%>%scroll_box(width = "100%")
```
