...
rel_abund_genefamily<-ariba_rpkm_genefamily%>%
...
writexl::write_xlsx(rel_abund_refname, "output/rel_abund_refname.xlsx")
writexl::write_xlsx(rel_abund_genefamily, "output/rel_abund_genefamily.xlsx")
