...
We group all beta-lactamic antibiotics in one group
...
ariba_rpkm_drugclass<-rbind(ariba_rpkm_drugclass, ariba_rpkm_beta_lactams)
```
...
ariba_rar_drugclass<-rbind(ariba_rar_drugclass, ariba_rar_beta_lactams)
```
