...
```{r}
drugclass_sig_rpkm_gcount<-sig_group_clin_dic(ariba_rpkm_drugclass, metadata, refname_ariba_drugclass, GCount)
...
```{r}
genefamily_sig_rpkm_gcount<-sig_group_clin_dic(ariba_rpkm_genefamily, metadata, refname_ariba_genefamily, GCount)
